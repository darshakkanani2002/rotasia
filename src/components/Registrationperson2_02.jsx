...
export default class Registrationperson2_02 extends Component {
    render() {
        return (
            <div>
                    ...
                    <div className='row mt-5'>
                        ...
                        <div className='col-12 col-lg-6 px-4 px-lg-5 mt-4'>
                            <div className='mb-4 registration-form-heading'>
                                ...
                                <h3 className='fw-boder'>We Would Like to know you better</h3>
                            </div>
                            {/* <div className='mb-5'>
                            ...
                            <form>
                                <div className='row'>
                                    <div className='col-12 col-lg-6 mb-4 mb-lg-0'>
                                        <div>
                                            <div>
                                                <label className='mb-3 registration-form-label'>Club Designation Person 2<span>*</span></label><br></br>
                                    ...
                                    <div className='col-12 col-lg-6 mb-4'>
                                        <div>
                                            <div>
                                                <label className='mb-3 registration-form-label'>District Destination Person 2</label><br></br>
                                ...
                                <div className='text-center text-lg-end  mt-lg-2 pt-4 pt-lg-4'>
                                    <Link to='/registrationperson2'><button className='registartion-prev-btn mx-4'>Previous</button></Link>
                                    <Link to='/registrationperson2_03'><button type="submit" className='registration-next-btn'>Next</button></Link>
                                </div>
                            </form>
                        </div>
                    </div>
